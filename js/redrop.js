$(window).ready(function() {
	...
	if($.cookie('griddata') == null) {
		...
		// var json = $.cookie('griddata');
		var json = JSON.parse($.cookie('griddata'));
	}
	...
	var grid_canvas = $(".gridster > ul").gridster({
		draggable: {
			stop: function(event, ui) {
				...
				// $.cookie('griddata', ''+positions+'');

				$.cookie('griddata', JSON.stringify(grid_canvas.serialize()));

				var changed = $.cookie('griddata');
				console.log(changed);
			}
		},
		widget_margins: [5, 5],
